...
app.model.Lend = (function () {
    ...
    Lend = {
        ...
        validatePurchasingPrice: function() {

            if(!Session.get('sellingPrice')) {
                return false;
            }

            var lowerValue = 1,
                highestValue = 1000000,
                sellingPrice = parseFloat(Session.get('sellingPrice'), 10);

            if(sellingPrice < lowerValue || sellingPrice > highestValue) {
                return false;
            }
