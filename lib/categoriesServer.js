...
server.model.Categories = (function () {
    ...
    Categories = {
        ...
        getAmazonCategory : function(amazonCategory) {
            if(this.amazonCategories[amazonCategory]) {
                return this.amazonCategories[amazonCategory];
            }
